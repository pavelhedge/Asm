...
.ifdef NEW_HOUR		; ##Часы#
	rcall NEW_HOUR	; Здесь и далее - если есть кукушка (сигнал) - включаем его
.endif
ldi temp2, 24
rcall RTC_sub	
...
RTC_sub:				; Подпрограммка-помощник. Загрузить - увеличить 
	ld temp1, Y			;  - сравнить с максимальным 
	inc temp1			; - обнулить-сохранить/добавить и выйти -сохранить
	cp temp1, temp2
	brlo end_time
	clr temp1
	st Y+, temp1
